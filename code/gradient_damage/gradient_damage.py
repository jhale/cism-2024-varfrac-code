...
def simple_monitor(u, alpha, iteration, Δalpha_norm, R_u_norm):
    print(
        f"staggered iteration: {iteration}, ||Δα||_2: {Δalpha_norm:3.4e}, ||R_u||_2: {R_u_norm:3.4e}"
    )
...
def alternate_minimization(
    ...
    raise RuntimeError(
        f"Could not converge after {max_iterations} iterations, ||Δα||_2: {Δalpha_norm:3.4e}, ||R_u||_2: {R_u_norm:3.4e}"
    )
